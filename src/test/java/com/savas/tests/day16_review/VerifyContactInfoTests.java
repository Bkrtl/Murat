package com.savas.tests.day16_review;

import com.savas.pages.ContactInfoPage;
import com.savas.pages.ContactsPage;
...
public class VerifyContactInfoTests extends TestBase {
   ...
   * */
    ...
    public void contactDetailsTest(){
        ...
        Assert.assertEquals(contactInfoPage.email.getText(),"mbrackstone9@example.com","verify emails");//--- bu line yukardaki 3 satırın, email verify etmek için yapılan kısayolu
