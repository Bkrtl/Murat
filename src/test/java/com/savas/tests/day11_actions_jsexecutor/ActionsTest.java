package com.savas.tests.day11_actions_jsexecutor;
...
public class ActionsTest {
    ...
    public void DragAndDrop(){
        ...
        String actualMessage=driver.findElement(By.id("droptarget")).getText();
        Assert.assertEquals(actualMessage,"You did great!","verify...");
    ...
    public void DragAndDropChaining(){
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//*[text()='You did great!']")).isDisplayed(),"Verify 'You did great!' displayed");
